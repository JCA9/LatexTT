...
\section{Artículo: Handwritten Optical Character Recognition (OCR): A Comprehensive Systematic Literature Review}
El artículo de Memon et al. (2020) realiza una revisión sistemática sobre los sistemas de OCR, destacando sus aplicaciones en sectores como la educación, la administración 
pública y las finanzas. El estudio evidencia que los modelos híbridos basados en redes neuronales convolucionales (CNN) y LSTM mejoran la precisión del reconocimiento de 
caracteres, especialmente en contextos multilingües.  
Entre sus conclusiones, los autores plantean que el OCR moderno, combinado con IA, es capaz de reducir hasta en un 80\% el tiempo de procesamiento de información escrita. 
En el contexto de las finanzas personales, esta tecnología permite la digitalización automática de tickets, simplificando el seguimiento de gastos.  
En opinión personal, este artículo respalda teóricamente la viabilidad del uso de OCR en la propuesta, al demostrar su madurez tecnológica y su aplicabilidad a sistemas con 
grandes volúmenes de texto estructurado.

\section{Trabajo Terminal: Sistema de Control Financiero con Categorización de Gastos}
Se revisó un trabajo terminal previo titulado \textit{Sistema de Control Financiero con Categorización de Gastos}, desarrollado en la ESCOM-IPN (2023). Este proyecto implementa 
una aplicación web que permite registrar gastos manualmente y generar reportes gráficos mensuales.  
Su ventaja principal fue la visualización de datos mediante gráficas dinámicas, pero adolece de automatización: los registros deben ingresarse manualmente. Además, no cuenta 
con un sistema OCR ni con IA para recomendaciones.  
En comparación, la propuesta actual amplía el alcance mediante la captura automática de datos con OCR y el análisis inteligente con IA, lo cual representa un salto tecnológico 
significativo.
