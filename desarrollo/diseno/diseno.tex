...
Alertas y predicciones: almacena notificaciones automáticas y resultados de proyecciones financieras generadas por el sistema.
...
Usuarios-Tickets: relación 1:N, donde un usuario puede registrar varios tickets.

Tickets-ProductosTickets: relación 1:N, cada ticket puede contener múltiples productos asociados.

Usuarios-Movimientos: relación 1:N, un usuario genera múltiples registros financieros.

Categorías-Movimientos: relación 1:N, cada movimiento pertenece a una categoría definida por el usuario.

Usuarios-Deudas-Usuarios: relación 1:N, que permite asignar deudas a usuarios específicos.

Movimientos-Predicciones: relación 1:N, cada movimiento puede tener una predicción asociada.
...
\begin{itemize}
    ...
    \item \textbf{Diagrama de Base de Datos}
    
    
    \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/E-R BD.png}
    \caption{Diagrama Entidad-Relación UML del sistema propuesto}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/Flujo del Sistema.png}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/FlujoOCR.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{./images/wireframesApp/LogIn.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesApp/Principal y Transacciones.JPG}
    \caption{Wireframe de la pantalla de principal y transacciones - App Móvil}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesApp/Presupuestos-Deudas-Notificaciones.JPG}
    \caption{Wireframe de la pantalla de presupuestos, deudas y notificaciones - App Móvil}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesApp/Escaneo-Verificacion-Tickets.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Dashboard_web.png}
    \caption{Wireframe del Dashboard Principal - Panel Web}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Presupuestos_web.png}
    \caption{Wireframe de la pantalla de Presupuestos - Panel Web}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Analisis_web.png}
    \caption{Wireframe de la pantalla de Análisis - Panel Web}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Dudas_web.png}
    \caption{Wireframe de la pantalla de Dudas - Panel Web}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Notificaciones_web.png}
    \caption{Wireframe de la pantalla de Notificaciones - Panel Web}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/wireframesWeb/Soluciones_web.png}
    \caption{Wireframe de la pantalla de Soluciones - Panel Web}
\end{figure}
