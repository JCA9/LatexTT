...
RNF01 & Seguridad &
Las contraseñas y datos personales deben almacenarse cifrados utilizando un algoritmo seguro (bcrypt) y no se guardara texto plano. \\

RNF02 & Mantenibilidad &
El código debe estar modularizado, documentado y versionado con control GitHub para facilitar actualizaciones. Cada modulo podra ser actualizado sin afectar la funcionalidad global. \\
