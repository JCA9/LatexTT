...
\begin{itemize}
    ...
    su arquitecturapuede no ser tan flexible como la de algunas bases de datos NoSQL para ciertos tipos de aplicaciones.
...
\begin{itemize}
    ...
    Paddle OCR es una herramienta de reconocimiento óptico de caracteres (OCR) desarrollada por Baidu. Es parte del ecosistema PaddlePaddle, una plataforma de aprendizaje
    ...
    Azure Form Recognizer es un servicio de inteligencia artificial proporcionado por Microsoft Azure que permite extraer información estructurada de documentos y formularios.
    Utiliza técnicas avanzadas de aprendizaje automático para identificar y extraer texto, tablas y campos clave-valor de una variedad de formatos de documentos. \cite{AzureDocumentI}
    Una ventaja de Azure Form Recognizer es su capacidad para manejar documentos complejos y variados sin necesidad de un entrenamiento extenso. Sin embargo, una 
    desventaja es que es un servicio basado en la nube, lo que puede implicar costos adicionales y preocupaciones de privacidad para algunos usuarios. \cite{AzureDocumentI}
\end{itemize}
...
\begin{itemize}
    ...
    Azure Web Services (AWS) es una plataforma de servicios en la nube proporcionada por Amazon. Ofrece una amplia gama de servicios, incluyendo computación, almacenamiento,
    bases de datos, análisis y redes. AWS es conocido por su escalabilidad, flexibilidad y seguridad, y es utilizado por empresas de todos los tamaños en todo el mundo. \cite{AWS} 
    En comparación con otras plataformas en la nube, AWS puede ser más complejo de configurar y administrar, lo que puede requerir un mayor conocimiento técnico por parte del
    administrador de la nube.

    \item Microsoft Azure
    
    Microsoft Azure es una plataforma de servicios en la nube proporcionada por Microsoft. Ofrece una amplia gama de servicios, incluyendo computación, almacenamiento, bases de
    datos, análisis y redes. Azure es conocido por su integración con productos de Microsoft, su escalabilidad y seguridad, y es utilizado por empresas de todos los tamaños en 
    todo el mundo. \cite{Azure} Una ventaja de Azure es su integración nativa con herramientas de desarrollo como Visual Studio y servicios empresariales como Office 365 y 
    Dynamics 365.

    \item Google Cloud Platform (GCP)
    
    Google Cloud Platform (GCP) es una plataforma de servicios en la nube proporcionada por Google. Ofrece una amplia gama de servicios, incluyendo computación, almacenamiento,
    bases de datos, análisis y redes. GCP es conocido por su innovación en inteligencia artificial y aprendizaje automático, así como por su infraestructura global. \cite{GCP}
    Una desventaja de GCP es que puede tener una menor cuota de mercado en comparación con AWS y Azure, lo que puede afectar la disponibilidad de recursos y soporte 
    en algunas regiones.
\end{itemize}
La infraestructura se desplegará en Microsoft Azure, debido a su buena integración con entornos de desarrollo basados en Microsoft, su facilidad para manejar 
...
\begin{itemize}
    ...
    sino que también garantizan que tu aplicación sea rápida, eficiente y lista para la puesta en producción desde el primer momento.\cite{WhyNextJS}
