...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Comparativo con el mismo período del año anterior
    \end{itemize}
...
\begin{enumerate}
    ...
    \item El sistema presenta estrategias de pago disponibles:
    \begin{itemize}
        \item Método de bola de nieve (menor saldo primero)
        \item Método de avalancha (mayor interés primero)
        \item Pago equilibrado proporcional
    \end{itemize}
    \item El usuario selecciona la estrategia preferida
...
\begin{enumerate}
    ...
    \item El sistema muestra alerta con el déficit calculado
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Días de anticipación para la alerta (7, 3, 1 día antes)
        \item Tipo de notificación (push, email, ambas)
        \item Horario preferido para recibir alertas
        \item Recordatorios recurrentes (diario hasta el pago)
    \end{itemize}
    ...
    \item El sistema registra las preferencias en el perfil del usuario
...
\begin{enumerate}
    ...
    \item Se proporciona guía para habilitar notificaciones
...
\begin{enumerate}
    ...
    \item El usuario selecciona el período del presupuesto (mensual, semanal)
    \item Para cada categoría, el usuario:
    \begin{itemize}
        \item Establece el monto límite
        \item Define el porcentaje de alerta (70%, 90%, 100%)
    ...
    \item El sistema activa el monitoreo automático
...
\textbf{FA-02: Más de 10 categorías}
\begin{enumerate}
    \item En el paso 2, si hay más de 10 categorías
    \item El sistema muestra mensaje de límite de categorías
    \item El usuario debe consolidar o eliminar categorías
    \item Se redirige a CU-11: Modificar Categoría de Gastos
\end{enumerate}
