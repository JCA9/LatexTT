...
Durante el Trabajo Terminal I se completaron las fases de análisis de requerimientos, diseño del sistema, implementación del frontend web y primeras pruebas del módulo OCR. Las fases de implementación del backend, desarrollo de la aplicación móvil, integración de componentes y pruebas exhaustivas se encuentran planificadas para el Trabajo Terminal II, con entrega estimada en julio de 2026.
