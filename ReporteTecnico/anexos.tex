...
Las siguientes imágenes corresponden a los resultados de la encuesta de usabilidad aplicada a \textbf{20 participantes} en dos etapas (\textbf{30 de abril} y \textbf{26 de mayo al 2 de junio de 2026}), tras interactuar con el sistema FINARA en condiciones reales de uso. Cada gráfica muestra la distribución de respuestas para las preguntas del formulario.
