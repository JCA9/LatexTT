...
El módulo de autenticación cubre el registro de nuevos usuarios y el inicio
de sesión. Tras autenticarse, el backend emite un JWT que el cliente almacena
de forma segura y adjunta en cada petición posterior.

\IfFileExists{../ManualUsuarioApp/images/RegistrarCuenta.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/RegistrarCuenta.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/AlIniciarSesion.png}
  \caption{Izq.: formulario de registro de cuenta. Der.: pantalla de inicio de sesión.}
  \label{fig:auth-registro-login}
\end{figure}
}{}
...
La pantalla principal (\campo{HomeScreen}) centraliza el resumen financiero
del usuario y sirve como punto de entrada a todos los módulos. La barra de
navegación inferior (\campo{BottomAppBar}) proporciona acceso directo a
Presupuestos, Deudas y el botón de escaneo OCR.

\IfFileExists{../ManualUsuarioApp/images/PantallaPrincipal.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/PantallaPrincipal.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/navbar.png}
  \caption{Izq.: pantalla principal con resumen financiero. Der.: barra de navegación inferior.}
  \label{fig:home-principal-navbar}
\end{figure}
}{}

\IfFileExists{../ManualUsuarioApp/images/IngresosPrincipales.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/IngresosPrincipales.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/DistribucionPresupuestos.png}
  \caption{Izq.: resumen de ingresos del período. Der.: distribución visual de presupuestos.}
  \label{fig:home-ingresos-distribucion}
\end{figure}
}{}

\IfFileExists{../ManualUsuarioApp/images/TransaccionesRecientes.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/TransaccionesRecientes.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/BotonEscaneo.png}
  \caption{Izq.: listado de transacciones recientes en el home. Der.: botón de escaneo de tickets.}
  \label{fig:home-transacciones-escaneo}
\end{figure}
}{}
...
\IfFileExists{../ManualUsuarioApp/images/PantallaFoto.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/PantallaFoto.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/CarruselFotos.png}
  \caption{Izq.: captura de ticket con cámara. Der.: carrusel de revisión previa.}
  \label{fig:ocr-captura-carrusel}
\end{figure}
}{}

\IfFileExists{../ManualUsuarioApp/images/ProgresoFoto.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/ProgresoFoto.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/ResultadoFoto.png}
  \caption{Izq.: pantalla de procesamiento OCR con pasos animados. Der.: resultado con productos extraídos.}
  \label{fig:ocr-proceso-resultado}
\end{figure}
}{}
...
\IfFileExists{../ManualUsuarioApp/images/Categorias.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/Categorias.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/FormularioCategorias.png}
  \caption{Izq.: listado de categorías predefinidas y personalizadas. Der.: formulario de nueva categoría.}
  \label{fig:categorias-listado-form}
\end{figure}
}{}
...
\IfFileExists{../ManualUsuarioApp/images/PanelPresupuesto.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/PanelPresupuesto.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/CrearNuevoPresupuesto.png}
  \caption{Izq.: panel de presupuestos por categoría. Der.: formulario de nuevo presupuesto.}
  \label{fig:presupuestos-panel-nuevo}
\end{figure}
}{}
...
\IfFileExists{../ManualUsuarioApp/images/PanelDeudas.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/PanelDeudas.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/NuevaDeuda.png}
  \caption{Izq.: panel de deudas activas. Der.: formulario de nueva deuda.}
  \label{fig:deudas-panel-nueva}
\end{figure}
}{}
...
El módulo de transacciones agrupa el registro manual de gastos e ingresos.
Desde la pantalla principal el usuario accede al historial unificado y puede
crear nuevos movimientos sin necesidad de fotografiar un ticket.

\subsubsection{Pantallas}

\IfFileExists{../ManualUsuarioApp/images/VentanaTransacciones.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/VentanaTransacciones.png}
  \hfill
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/NuevoGasto.png}
  \caption{Izq.: historial de transacciones. Der.: formulario de nuevo gasto.}
  \label{fig:transacciones-historial-gasto}
\end{figure}
}{}

\IfFileExists{../ManualUsuarioApp/images/NuevoIngreso.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/NuevoIngreso.png}
  \caption{Formulario de registro de ingreso.}
  \label{fig:transacciones-ingreso}
\end{figure}
}{}
...
El módulo de notificaciones muestra alertas de presupuesto (uso $>$ 80\,\% y
superación del límite) y recordatorios de pagos de deudas próximos. Las
alertas se generan en el backend y se leen desde la pantalla dedicada.

\IfFileExists{../ManualUsuarioApp/images/Notificaciones.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/Notificaciones.png}
  \caption{Pantalla de notificaciones y alertas del sistema.}
...
La pantalla de perfil permite al usuario consultar su información registrada
y cerrar sesión. El cierre de sesión elimina el token JWT almacenado y
redirige al flujo de autenticación.

\IfFileExists{../ManualUsuarioApp/images/Perfil.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{../ManualUsuarioApp/images/Perfil.png}
...
\subsection{Arquitectura general de la plataforma web}

\subsubsection{Stack tecnológico}

\begin{longtable}{>{\bfseries\small}p{3.5cm} p{10cm}}
  \caption{Stack tecnológico de la plataforma web FINARA}
  \label{tab:stack-web} \\
  \toprule
  Componente & Descripción \\
  \midrule
...
La plataforma web se organiza por rutas y módulos de dominio dentro de
\archivo{src/app/}, con componentes reutilizables y servicios desacoplados en
\archivo{src/lib/}.

\begin{lstlisting}[style=codigobase, language={},
    caption={Estructura de directorios relevante en la plataforma web}]
src/
|-- app/
|   |-- dashboard/
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/implementacion/screenshoot_cargar_ticketdigital.png}
  \caption{Carga de ticket digital desde la plataforma web: selección de archivo y previsualización.}
  \label{fig:impl-upload-ticket}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/implementacion/screenshoot_revisionticket.png}
  \caption{Revisión y corrección de datos extraídos por OCR antes del guardado del ticket.}
  \label{fig:impl-review-ocr}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/implementacion/screenshoot_dashboard_web.png}
  \caption{Dashboard web: resumen financiero, gráficas por período e indicadores de presupuesto.}
...
La plataforma web se manejan reportes:
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/implementacion/screenshoot_generar_reporte.png}
  \caption{Generación de reportes en PDF y Excel desde el dashboard.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/implementacion/screenshoot_recomendaciones.png}
  \caption{Módulo de recomendaciones: análisis financiero personalizado con acciones sugeridas.}
  \label{fig:impl-recommendations}
\end{figure}
