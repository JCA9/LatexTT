...
\begin{description}
  ...
  \item[Backend:] Conjunto de procesos, servicios y componentes que se ejecutan del lado del servidor y que son responsables de la lógica de negocio, el procesamiento de datos, la gestión de la base de datos y la comunicación con la aplicación cliente. \\
  El backend recibe solicitudes provenientes del cliente, las valida, aplica reglas de negocio, accede a los datos necesarios y devuelve una respuesta estructurada. Su función principal es garantizar el funcionamiento correcto, seguro y coherente del sistema, independientemente de la interfaz que utilice el usuario.
