...
Para la capa de la presentación web ocuparemos \textbf{Next.js}, nos decidimos por esta tecnología ya que sabemos como funciona React.js y Next.js es un framework basado en React que facilita la creación de aplicaciones web,
por otra parte una ventaja de este framework recae en su capacidad para manejar grandes volúmenes de tráfico y contenido dinámico lo hace indicado para nuestro proyecto. 
Ademas, debido a su sistema de renderizado híbrido y optimización automática, Next.js garantiza que tus aplicaciones sean rápidas y eficientes. \cite{WhyNextJS}
