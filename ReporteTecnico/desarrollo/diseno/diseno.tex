...
\begin{itemize}
    ...
    según la tesis de Roy T. Fielding; en seguridad de endpoints y sesiones, se siguen lineamientos de OWASP ASVS \cite{Arquitectura}.
...
El modelo relacional constituye la base del diseño lógico de la base de datos, al permitir identificar las entidades del dominio del problema y las relaciones existentes entre ellas.
De acuerdo con Connolly y Begg \cite{ModeloER}, un modelo E-R “proporciona una representación conceptual de alto nivel que describe los datos de una organización y las asociaciones entre ellos”.
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{./images/Modelo-BD2.png}
    \caption{Modelo relacional del sistema propuesto    }
    \end{figure}

En la Figura anterior presentamos el modelo relacional del sistema de finanzas personales, diseñado bajo un enfoque relacional utilizando MySQL como gestor de base de datos.
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/CasosUsoApp.png}
    \caption{Diagrama UML de Casos de Uso - App Móvil}
    \end{figure}

    \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{./images/CasosUsoWeb.png}
    ...
    \centering
    \includegraphics[width=0.82\textheight, height=\textwidth, keepaspectratio]{./images/DiagramaSecuenciaInicioSesion.png}
    \caption{Diagrama UML de Secuencia - Inicio de Sesión}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight, height=\textwidth, keepaspectratio]{./images/DiagramaSecuenciaOCR.png}
    \caption{Diagrama UML de Secuencia - Procesamiento OCR}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight, height=\textwidth, keepaspectratio]{./images/DiagramaSecuenciaCategorizacion.png}
    \caption{Diagrama UML de Secuencia - Procesamiento de Categorización}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight, height=\textwidth, keepaspectratio]{./images/DiagramaSecuenciaReportes.png}
    ...
    \begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight, height=\textwidth, keepaspectratio]{./images/Flujo-OCR2.png}
