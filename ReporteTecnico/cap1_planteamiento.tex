...
Según la Encuesta Nacional sobre Salud Financiera (ENSAFI) 2023, solo el 53.2\% de la población realiza algún tipo de registro o control de sus gastos, y únicamente el 32.8\% cumple con dicho registro \cite{inegi2024}.Este comportamiento refleja una falta de conciencia y disciplina financiera que puede llevar a 
...
la gestión financiera personal de manera clara y fácil de utilizar(De las cuales hablaremos en el Capítulo 2, Marco Teórico.). Las herramientas seleccionadas se centran en automatizar la captura y categorización de gastos, ofrecer análisis 
...
ingresar o corregir los datos del ticket donde el OCR no haya sido preciso o si llega a haber alguna incongruencia. 

Además, la aplicación integrará algoritmos de categorización automática que clasificarán los gastos en diferentes rubros (alimentación, transporte, entretenimiento, etc.) basandonos en el modelo de sobres de Dave Ramsey (Del cuales hablaremos en el Capítulo 2, Marco Teórico.). 

Para mejorar la comprensión de los gastos, se emplearán tableros interactivos y gráficos dinámicos, basados en bibliotecas de visualización como ECharts o D3.js, que permitan al usuario identificar patrones de consumo y tendencias temporales. Según el informe de la OECD/INFE (2023), una alfabetización financiera más elevada —incluyendo el uso de herramientas digitales— está asociada con comportamientos financieros más responsables y una mayor capacidad para tomar decisiones informadas sobre el ahorro y el gasto \cite{OECD_INFE2023}. 
Esto sugiere que la visualización de datos financieros podría fortalecer la educación financiera práctica y apoyar la toma de decisiones más consciente.
...
Finalmente, se implementará un sistema de notificaciones y alertas que informen al usuario sobre sus límites de gasto o posibles desviaciones de su presupuesto. 
...
retención en el uso de aplicaciones y la dificultad de análisis financiero. La integración de OCR, visualización interactiva y alertas crea un ecosistema digital 
...
\begin{itemize}
    \item Crear el módulo de escaneo de tickets físicos mediante la aplicación móvil. 
    \item Crear el módulo de escaneo de tickets digitales mediante la plataforma web.
    ...
    \item Construir el módulo de generación de informes y reportes de gastos mensuales y anuales. 
    \item Analizar y visualizar el módulo de análisis de gastos con gráficas interactivas y tendencias.
    \item Implementar el módulo de ingreso y corrección manual de datos de gastos.
    \item Diseñar el módulo de creación de planes financieros y seguimiento de deudas. 
\end{itemize}
...
y notificaciones también contribuye a mantener a los usuarios informados sobre su situación financiera, ayudándoles a evitar gastos excesivos y a adherirse a sus 
...
el 43.8\% con acceso a computadoras \cite{EncINEGI}.
