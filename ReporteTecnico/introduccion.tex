...
Caracteres (OCR), las cuales permiten leer y procesar los datos contenidos en tickets físicos o digitales. Posteriormente, la información se clasifica según reglas heurísticas basadas en palabras clave y patrones de texto. Los datos procesados se almacenan en una base de datos relacional, desde donde pueden ser consultados, filtrados y analizados por el usuario.
